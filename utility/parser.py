...
def parse_args():
    ...
    parser.add_argument('--se', type=int, default=1, help='0 if no Structural Entropy Pooling')
    parser.add_argument('--beta_pool', type=float, default=0.20, help='h+beta*h_saved')
    ...
    parser.add_argument('--hgcn_mix', nargs='?', default='[1, 1e-3]')
    parser.add_argument('--hgcn_mix1', type=float, default=1)
    parser.add_argument('--hgcn_mix2', type=float, default=1e-3)
    ...
    parser.add_argument('--pre_lr', type=float, default=0.05,
                        help='Learning rate. 0.05 for mx/cn. 0.01 for steam')
