...
# 指定文件夹路径和输出文件名
input_directory = './Data/xmrec_au/metadata'  # 替换为实际目录路径
output_file = './Data/xmrec_au/metadata/all.json'
# 调用函数
merge_json_gz_files(input_directory, output_file)


# 指定文件夹路径和输出文件名
input_directory = './Data/xmrec_au/rating'  # 替换为实际目录路径
output_file = './Data/xmrec_au/rating/all.txt'
